...
namespace WallBudget
{
    public partial class editBill : Form
    {
        ...
        public editBill(MySqlConnection connection)
        {
            InitializeComponent();
            conn = connection;
        }
        ...
        private void cmbSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = $"UPDATE bills set Description {newContents[0]}, Amount = {Convert.ToDouble(newContents[1])}, Due {newContents[2]}, Notes {newContents[3]}, Status {newContents[4]} WHERE Description = '{rowContents[0]}';";
